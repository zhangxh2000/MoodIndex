...
public class PostParser implements IProcess {
    ...
    public class ParserResult {
        ...
        public boolean thisDayHasReached;
    }
    ...
    public CountParserResult parserResult(String content) {
        CountParserResult result = new CountParserResult();
        JSONObject jsonObject = JSONObject.parseObject(content);
        if (jsonObject == null) {
            LOGGER.info(content);
            return result;
...
//                //not same day
//                if (time>context.createdTime) {
//                    //newer day
//                    if (!result.thisDayFinished) {
//                        result.thisDayFinished = true;
//                    }
//                    continue;
//                } else {
